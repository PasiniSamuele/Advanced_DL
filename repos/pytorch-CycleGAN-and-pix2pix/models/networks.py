...
class NLayerDiscriminator(nn.Module):
    ...
    def __init__(self, input_nc, ndf=64, n_layers=3, norm_layer=nn.BatchNorm2d):
        ...
        kw = 4
        padw = 1
        sequence = [nn.Conv2d(input_nc, ndf, kernel_size=kw, stride=2, padding=padw), norm_layer(ndf), nn.ReLU(True)]
        nf_mult = 1
        nf_mult_prev = 1
        ...
        sequence += [nn.Conv2d(ndf * nf_mult, 1, kernel_size=kw, stride=1, padding=padw), norm_layer(1), nn.ReLU(True)]  # output 1 channel prediction map
