...
class ECycleGANModel(BaseModel):
    """
    This class implements the ECycleGAN model, for learning image-to-image translation without paired data.
    ...
    def __init__(self, opt):
        ...
        self.netG_A = networks.define_G(opt.input_nc, opt.output_nc, opt.ngf, "RDNB", opt.norm,
                                        not opt.no_dropout, opt.init_type, opt.init_gain, self.gpu_ids, 
                                        opt.num_dense_layers, opt.num_dense_subblocks, opt.residual_scaling)
        self.netG_B = networks.define_G(opt.output_nc, opt.input_nc, opt.ngf, "RDNB", opt.norm,
                                        not opt.no_dropout, opt.init_type, opt.init_gain, self.gpu_ids, 
                                        opt.num_dense_layers, opt.num_dense_subblocks, opt.residual_scaling)
        ...
        if self.isTrain:
            ...
            self.criterionIdt = networks.PerceptualLoss(i=opt.perc_i, j=opt.perc_j, channels=opt.input_nc).to(self.device)
